        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-semibold hidden md:block">The Evolution Meeting</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/programs" className="text-white hover:text-gray-200 transition-colors">Programs</Link>
            <Link to="/events" className="text-white hover:text-gray-200 transition-colors">Events</Link>
            <Link to="/impact-stories" className="text-white hover:text-gray-200 transition-colors">Impact Stories</Link>
            <Link to="/volunteer" className="text-white hover:text-gray-200 transition-colors">Volunteer</Link>
